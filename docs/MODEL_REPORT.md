...
| Metric | Value |
|---|---|
| Accuracy | **0.7463** (0.7463414634146341) |
| Macro-F1 | **0.7412** (0.7411616161616161) |
| ROC-AUC | **0.7580** (0.7580309339678764) |
| Precision (good) | 0.8198 |
| Recall (good) | 0.7398 |
| F1 (good) | 0.7778 |
| Precision (bad) | 0.6596 |
| Recall (bad) | **0.7561** |
| F1 (bad) | 0.7045 |

Decision threshold: **0.58**, tuned on validation only.

Read plainly: on a person the model has never seen, it is right about **75%** of the time.
It achieves **75.6% recall on bad form** (up from 34.1% in V1), successfully catching three out of four
form errors on unseen subjects, while maintaining **74.0% recall on good form** and **82.0% precision on good form**.
